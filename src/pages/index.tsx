...
export default function IndexPage() {
  ...
  const { ref: brandingRef_1, show: brandingShow_1 } = useScrollTrigger(
    0.3,
    true,
  );
  const { ref: introductionRef, show: introductionShow } =
    useScrollTrigger(0.15);
  ...
  const [slides, setSlides] = useState <
    { url: string; textColor: "text-white" | "text-[#527aaf]" }[]
    > ([]);
      ...
      <div ref={scrollRef}>
        ...
        <section className="relative w-full overflow-hidden mt-6">
          ...
          <div className="absolute inset-0 flex justify-start">
            <div
              className={`h-full ${isMobile ? "rounded-r-[100px] w-[80%]" : "rounded-r-[500px] w-[60%]"} bg-gradient-to-b from-[#d3e3ed] to-[#d3e3ed00]`}
            />
          </div>
          ...
          <div
            ref={brandingRef}
            className={`relative z-10 ${isMobile ? "pl-12 pr-2 w-[70%]" : "pl-48 pr-36 w-[60%]"} py-8 md:py-10 text-center`}
          >
            <motion.div
            ...
            <p className="mt-4 text-gray-700 leading-relaxed">
              Với hành trình hơn hai thập kỷ hình thành và phát triển kể từ năm
              2003, VLXD <strong>Xuân Hương</strong> đã trở thành người bạn đồng
              hành đáng tin cậy của hàng ngàn công trình lớn nhỏ. Chúng tôi
              không chỉ bán vật liệu xây dựng, chúng tôi mang đến những mảnh
              ghép hoàn hảo để hoàn thiện vẻ đẹp cho ngôi nhà của bạn. Chúng tôi
              hiểu rằng mỗi công trình là một tác phẩm nghệ thuật, và vẻ đẹp của
              nó được tạo nên từ những vật liệu chất lượng nhất.
            </p>
        ...
        <section className="relative w-full overflow-hidden mt-6">
          ...
          <div className="absolute inset-0 flex justify-end">
            <div
              className={`h-full bg-gradient-to-b ${isMobile ? "rounded-l-[100px] w-[80%]" : "rounded-l-[500px] w-[60%]"} from-[#d3e3ed] to-[#d3e3ed00]`}
            />
          </div>
          ...
          <div
            ref={brandingRef_1}
            className={`relative z-10 ml-auto ${isMobile ? "pr-10 pl-2 w-[70%]" : "pr-52 pl-36 w-[60%]"} py-20 text-center`}
          >
            <motion.div
            ...
            <p className="mt-4 text-gray-700 leading-relaxed">
              Thế mạnh của chúng tôi là các sản phẩm trang trí nội ngoại thất
              tinh tế và đa dạng:
            </p>
            <ul
              className={`list-disc list-inside mt-4 ${isMobile ? "pl-6" : "pl-16"} text-left`}
            >
              <li>Gạch & Đá: Mang đến sự sang trọng và cá tính.</li>
              <li>
                Ngói & Sỏi: Tạo nên điểm nhấn độc đáo và hài hòa với thiên
                nhiên.
              </li>
              <li>
                Keo dán & chống thấm: Đem lại sự vững chắc an toàn theo thời
                gian
              </li>
            </ul>
        ...
        <section
          className={`flex flex-col items-start ${isMobile ? "px-4" : "px-20"} py-8 md:py-10 leading-none`}
        >
          <p
            className={`${isMobile ? "text-7xl" : "text-9xl"} font-gilroy font-extrabold text-transparent stroke-text`}
          >
            Xuân
          </p>
          <p
            className={`-mt-4 ${isMobile ? "text-[80px]" : "text-[150px]"} font-gilroy font-extrabold text-white stroke-text`}
          >
            Hương
          </p>
        </section>
        <section
          ref={introductionRef}
          className={`flex flex-col items-start justify-center ${isMobile ? "px-4" : "px-20"} gap-4 py-2 md:py-8`}
        >
          <motion.p
            animate={
              introductionShow ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
            }
          ...
          >
            ...
            Với phương châm "Lấy uy tín tạo nên thương hiệu", chúng tôi cam kết
            mang đến cho Quý khách hàng những sản phẩm vượt trội cùng dịch vụ tư
            vấn chuyên nghiệp, tận tâm, góp phần kiến tạo nên những không gian
            sống đẳng cấp và bền vững cùng thời gian.
          </motion.p>
        </section>
      </div>
    </DefaultLayout>
